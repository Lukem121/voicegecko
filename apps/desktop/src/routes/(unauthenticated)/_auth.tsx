...
function AuthLayout() {
  ...
  return (
    <>
      <AuthTitleBar />
      <div className="relative grid h-dvh flex-col items-center justify-center pt-12 lg:max-w-none lg:px-0">
        <div className="-z-10 absolute top-0 left-0 h-full w-full overflow-hidden">
          ...
          >
            <div
              className="-translate-x-1/2 relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] bg-gradient-to-tr from-[#6E9C4A]/70 via-[#6E9C4A]/75 to-[#6E9C4A]/90 opacity-25 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
              style={{
                clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)',
              }}
            />
