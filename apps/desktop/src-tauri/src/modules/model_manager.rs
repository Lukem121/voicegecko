...
pub const DEFAULT_GPU_WHISPER_MODEL_ID: &str = "small.en";
...
pub fn set_gpu_whisper_model_id(
    ...
    store.save()?;
    crate::speech::whisper_sidecar::invalidate_server();
    Ok(())
}
...
fn get_initial_models() -> HashMap<String, Model> {
    let models_data = vec![
        ...
        (
            "base.en",
            "Base English",
            "Bundled English-only model. Fast fallback while better models download.",
            "142 MiB",
            "~1.5 GB",
        ...
        (
            "small.en",
            "Small English",
            "Recommended everyday English dictation model.",
            "466 MiB",
            "~2 GB",
        ...
        (
            "small.en-tdrz",
            "Small English TDRZ",
            "Specialized English small model with TDRZ speaker-turn timestamps.",
            "465 MiB",
            "~2 GB",
        ...
        (
            "medium.en",
            "Medium English",
            "High-quality English-only model for professional dictation.",
            "1.5 GiB",
            "~4 GB",
        ...
        (
            "medium.en-q5_0",
            "Medium English Q5_0",
            "English medium model with Q5_0 quantization.",
            "514 MiB",
            "~4 GB",
        ...
        (
            "medium.en-q8_0",
            "Medium English Q8_0",
            "Highest quality medium English model with Q8_0 quantization.",
            "785 MiB",
            "~4 GB",
        ...
        (
            "large-v3-turbo",
            "Large V3 Turbo",
            "Best local accuracy we ship for dictation, without full large-v3 cost.",
            "1.5 GiB",
            "~8 GB",
